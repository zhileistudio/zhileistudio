...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    const pinEnd = lastCardTop - stackPositionPx - (cardsRef.current.length - 1) * itemStackDistance;
  ...
  const updateSpacerHeight = useCallback(() => {
    ...
    if (endElement) {
      endElement.style.height = '40px'; // Seamless, tight spacing below the stack
    }
  }, []);
